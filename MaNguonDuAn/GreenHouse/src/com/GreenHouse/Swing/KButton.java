...
public class KButton extends JButton {
    ...
    public Color kStartColor = new Color(86, 204, 242);
    public Color kEndColor = new Color(47, 128, 237);
    public Color kHoverStartColor = new Color(0, 180, 219);
    public Color kHoverEndColor = new Color(0, 131, 176);
    public Color kHoverColor = Color.white;
    public Color kHoverForeGround = new Color(255, 140, 0);
