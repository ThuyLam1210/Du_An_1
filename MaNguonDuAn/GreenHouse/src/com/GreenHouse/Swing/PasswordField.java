...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/com/GreenHouse/Icon/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/com/GreenHouse/Icon/eye_hide.png")).getImage();
