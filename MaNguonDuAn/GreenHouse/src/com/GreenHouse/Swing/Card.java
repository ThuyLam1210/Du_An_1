...
public class Card extends javax.swing.JPanel {
    ...
    public void setIcon(GoogleMaterialDesignIcon icon) {
        this.icon = icon;
        lblIcon.setIcon(new GoogleMaterialIcon(icon, GradientType.DIAGONAL_1, new Color(191, 191, 191), Color.WHITE, 32).toIcon());
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.setPaint(new GradientPaint(0, 0, lblIcon.getColor1(), getWidth(), 0, lblIcon.getColor2()));
        g2.fill(area);
        g2.dispose();
    ...
    public Color getColor1() {
        return lblIcon.getColor1();
    }

    public void setColor1(Color color1) {
        lblIcon.setColor1(color1);
    }

    public Color getColor2() {
        return lblIcon.getColor2();
    }

    public void setColor2(Color color2) {
        lblIcon.setColor2(color2);
    }
    ...
    public String getTieuDe(){
        return lblTieuDe.getText();
    }
    public void setData(ModelCard data) {
        lbValues.setText(data.getValues());
        lbDescription.setText(data.getDescription());
        lblTieuDe.setText(data.getValues());
    ...
    private void initComponents() {
        ...
        lblIcon = new com.GreenHouse.Swing.LabelIcon();
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(lblTieuDe, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private com.GreenHouse.Swing.LabelIcon lblIcon;
